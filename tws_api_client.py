...
# Static ASCII art fallback if pyfiglet is unavailable
STATIC_ASCII_ART = f"""
{GREEN}
   _____ _          _ _       
  / ____| |        (_) |      
...
def generate_ascii_art():
    """Generate dynamic ASCII art with A B H I I using pyfiglet if available."""
    if PYFIGLET_AVAILABLE:
        try:
            f = Figlet(font='doom')
            art = f.renderText('A B H I I')
            return f"{GREEN}{art}\nTWS REST API CLIENT - v1.0{RESET}"
        except Exception:
...
class TWSApiClient:
    ...
    def submit_ad_hoc_job(self, plan_id, job_data):
        ...
        try:
            response = self.session.post(
                f"{self.base_url}/v1/{self.engine}/plan/{plan_id}/job/action/submit_ad_hoc_job",
                auth=self.auth,
                json=job_data,
    ...
    def get_job_status(self, plan_id, job_id):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/v1/{self.engine}/plan/{plan_id}/job/{job_id}",
                auth=self.auth,
                headers=self.headers,
                timeout=30,
                proxies=self.proxies,
    ...
    def hold_job(self, plan_id, job_id):
        ...
        try:
            response = self.session.put(
                f"{self.base_url}/v1/{self.engine}/plan/{plan_id}/job/{job_id}/action/hold",
                auth=self.auth,
                headers=self.headers,
                timeout=30,
                proxies=self.proxies,
    ...
    def release_job(self, plan_id, job_id):
        ...
        try:
            response = self.session.put(
                f"{self.base_url}/v1/{self.engine}/plan/{plan_id}/job/{job_id}/action/release",
                auth=self.auth,
                headers=self.headers,
                timeout=30,
                proxies=self.proxies,
    ...
    def cancel_job(self, plan_id, job_id):
        ...
        try:
            response = self.session.put(
                f"{self.base_url}/v1/{self.engine}/plan/{plan_id}/job/{job_id}/action/cancel",
                auth=self.auth,
                headers=self.headers,
                timeout=30,
                proxies=self.proxies,
    ...
    def rerun_job(self, plan_id, job_id):
        ...
        try:
            response = self.session.put(
                f"{self.base_url}/v1/{self.engine}/plan/{plan_id}/job/{job_id}/action/rerun",
                auth=self.auth,
                headers=self.headers,
                timeout=30,
                proxies=self.proxies,
    ...
    def create_job_definition(self, job_definition_data):
        ...
        try:
            response = self.session.post(
                f"{self.base_url}/v1/{self.engine}/model/jobdefinition",
                auth=self.auth,
    ...
    def get_job_definition(self, job_definition_name):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/v1/{self.engine}/model/jobdefinition/{job_definition_name}",
                auth=self.auth,
                headers=self.headers,
                timeout=30,
                proxies=self.proxies,
    ...
    def create_workstation(self, workstation_data):
        ...
        try:
            response = self.session.post(
                f"{self.base_url}/v1/{self.engine}/model/workstation",
                auth=self.auth,
    ...
    def get_workstation(self, workstation_name):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/v1/{self.engine}/model/workstation/{workstation_name}",
                auth=self.auth,
                headers=self.headers,
                timeout=30,
                proxies=self.proxies,
    ...
    def create_calendar(self, calendar_data):
        ...
        try:
            response = self.session.post(
                f"{self.base_url}/v1/{self.engine}/model/calendar",
                auth=self.auth,
                json=calendar_data,
                headers=self.headers,
                timeout=30,
    ...
    def get_calendar(self, calendar_name):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/v1/{self.engine}/model/calendar/{calendar_name}",
                auth=self.auth,
                headers=self.headers,
                timeout=30,
                proxies=self.proxies,
    ...
    def submit_job_stream(self, plan_id, job_stream_data):
        ...
        try:
            response = self.session.post(
                f"{self.base_url}/v1/{self.engine}/plan/{plan_id}/jobstream/action/submit",
                auth=self.auth,
    ...
    def get_job_stream_status(self, plan_id, job_stream_id):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/v1/{self.engine}/plan/{plan_id}/jobstream/{job_stream_id}",
                auth=self.auth,
                headers=self.headers,
                timeout=30,
                proxies=self.proxies,
    ...
    def create_job_stream_definition(self, job_stream_data):
        ...
        try:
            response = self.session.post(
                f"{self.base_url}/v1/{self.engine}/model/jobstream",
                auth=self.auth,
                json=job_stream_data,
                headers=self.headers,
                timeout=30,
    ...
    def get_job_stream_definition(self, job_stream_name):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/v1/{self.engine}/model/jobstream/{job_stream_name}",
                auth=self.auth,
                headers=self.headers,
                timeout=30,
                proxies=self.proxies,
    ...
    def get_engine_status(self):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/v1/{self.engine}/status",
                auth=self.auth,
                headers=self.headers,
                timeout=30,
                proxies=self.proxies,
    ...
    def create_resource(self, resource_data):
        ...
        try:
            response = self.session.post(
                f"{self.base_url}/v1/{self.engine}/model/resource",
                auth=self.auth,
                json=resource_data,
                headers=self.headers,
                timeout=30,
    ...
    def get_resource(self, resource_name):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/v1/{self.engine}/model/resource/{resource_name}",
                auth=self.auth,
                headers=self.headers,
                timeout=30,
                proxies=self.proxies,
    ...
    def create_prompt(self, prompt_data):
        ...
        try:
            response = self.session.post(
                f"{self.base_url}/v1/{self.engine}/model/prompt",
                auth=self.auth,
                json=prompt_data,
                headers=self.headers,
                timeout=30,
    ...
    def get_prompt(self, prompt_name):
        ...
        try:
            response = self.session.get(
                f"{self.base_url}/v1/{self.engine}/model/prompt/{prompt_name}",
                auth=self.auth,
                headers=self.headers,
                timeout=30,
                proxies=self.proxies,
